      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="aspect-[4/5] rounded-3xl overflow-hidden border border-background/10 bg-secondary relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center text-background/30 p-8">
                  <div className="w-24 h-24 rounded-full border-2 border-background/20 mx-auto mb-4 flex items-center justify-center">
                    <Award size={40} className="opacity-50" />
                  </div>
                  <p className="font-serif italic text-lg">[Divjot Singh Arora Portrait]</p>
                </div>
              </div>
              
              <div className="absolute bottom-0 left-0 w-full p-8 z-20">
                <div className="flex gap-4">
                  <a href="#" className="p-3 bg-background/10 hover:bg-accent rounded-full backdrop-blur-md transition-colors text-background">
                    <Linkedin size={20} />
                  </a>
                  <a href="#" className="p-3 bg-background/10 hover:bg-accent rounded-full backdrop-blur-md transition-colors text-background">
                    <Twitter size={20} />
