        ...
        <div className="grid lg:grid-cols-3 gap-10">
          {books.map((book, index) => (
            <motion.div
              ...
              whileHover={{ y: -5 }}
              className="group flex flex-col h-full glass-card rounded-3xl overflow-hidden hover:shadow-2xl transition-all duration-300 bg-white/60 dark:bg-gray-900/60"
            >
